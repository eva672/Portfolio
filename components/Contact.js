  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-8 py-20">
      <div className="max-w-2xl mx-auto w-full">
        <h2 className="text-4xl font-bold text-pink-600 mb-12 text-center">Get In Touch</h2>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <h3 className="text-lg font-medium text-pink-700 mb-4">Or reach out directly</h3>
