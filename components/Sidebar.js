...
export default function Sidebar() {
  return (
    <div className="w-64 bg-gray-900 text-white h-screen fixed left-0 top-0 p-8 flex flex-col">
      {/* Profile Section */}
      <div className="text-center mb-12">
        ...
        <h1 className="text-2xl font-bold">Eva Manuska</h1>
      ...
      <nav className="flex-1">
        <ul className="space-y-4">
          ...
          <li>
            <Link href="/projects" className="flex items-center space-x-3 text-gray-300 hover:text-white transition-colors">
              <span>Projects</span>
            </Link>
          </li>
          <li>
            <Link href="/blog" className="flex items-center space-x-3 text-gray-300 hover:text-white transition-colors">
              <span>Blog</span>
            </Link>
          </li>
          <li>
            <Link href="/contact" className="flex items-center space-x-3 text-gray-300 hover:text-white transition-colors">
              <span>Contact</span>
            </Link>
          </li>
        </ul>
      ...
      <div className="mt-auto pt-8 border-t border-gray-800">
        <div className="flex space-x-4">
          <a href="https://github.com/eva672" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="GitHub">
