...
export default function Certifications() {
  return (
    <section id="certifications" className="w-full py-16 bg-gray-50 dark:bg-gray-800">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {certifications.map((cert, index) => (
            <a
              ...
              className="group block bg-white dark:bg-gray-700 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-600 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
              <div className="p-6">
